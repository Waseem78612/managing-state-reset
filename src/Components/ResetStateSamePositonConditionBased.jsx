...
export default function ResetStateSamePositonConditionBased() {
      ...
      <div className="max-w-md w-full">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Conditional rendering in same position
          </p>
        </div>
      ...
      <div className="text-center">
        ...
        <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
          <div className="text-sm text-gray-500 dark:text-gray-400 flex items-center justify-center gap-2">
            ...
            ></div>
            <span>
              {hover ? "Hovering" : "Ready"} • Score will reset on player switch
            </span>
          </div>
        </div>
      </div>
